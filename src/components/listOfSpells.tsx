...
const ListOfSpells = () => {
  ...
  return (
    <BasicLayout>
        <div className="text-2xl font-semibold text-primaryColor text-center mb-6">List of Spells</div>
      <div className="flex flex-col gap-2">
        {spellData &&
          spellData?.map((spell, index) => (
            <div key={index} className="bg-gray-100 hover:bg-gray-300 rounded-md px-4 py-2 cursor-pointer transition-all duration-150 ease-in-out">
